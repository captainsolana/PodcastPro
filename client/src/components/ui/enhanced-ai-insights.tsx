...
export function EnhancedAIInsights({ 
  ...
  const getCategoryIcon = (category: string = 'content') => {
    switch (category) {
      ...
      case 'engagement': return 'energy';
      case 'content': return 'idea';
      case 'flow': return 'trending';
  ...
  return (
  <Card className={cn("enhanced-ai-insights interactive", className)} data-elevation-tier={1}>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center">
              <AppIcon name="bot" className="text-white w-4 h-4" />
            </div>
            <CardTitle className="heading-sm">AI Insights</CardTitle>
          ...
          {totalCount > 0 && (
            <div className="flex items-center space-x-2">
              ...
              {appliedCount === totalCount && (
                <AppIcon name="success" className="w-4 h-4 text-success" />
              )}
            </div>
          )}
        </div>
      ...
      <CardContent>
        {!hasSuggestions ? (
          <div className="text-center py-8">
            <AppIcon name="bot" className="w-12 h-12 text-muted-foreground mx-auto mb-3" />
            <h4 className="heading-xs font-medium mb-2">No AI insights generated yet</h4>
            ...
            >
              {isGeneratingSuggestions ? (
                ...
                <>
                  <AppIcon name="idea" className="w-4 h-4 mr-2" />
                  Get AI Insights
                </>
              )}
            </Button>
                        ...
                        <div className="flex items-start space-x-3 flex-1">
                          <div className={cn(
                            ...
                            {isApplied ? (
                              ...
                              <AppIcon name={CategoryIcon as any} className="w-4 h-4 text-primary" />
                            )}
                          </div>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center text-xs text-muted-foreground">
                              <AppIcon name="target" className="w-3 h-3 mr-1" />
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-border/50">
                        ...
                        {!isApplied && (
                          ...
                          >
                            {isApplying ? (
                              <>
                                <AppIcon name="refresh" className="w-3 h-3 mr-1 animate-spin" />
                                Applying...
                              </>
                            ) : (
                              <>
                                <AppIcon name="chevronRight" className="w-3 h-3 mr-1" />
                                Apply Change
                              </>
                            )}
                          </Button>
            ...
            <div className="flex items-center justify-between">
              ...
              >
                {isGeneratingSuggestions ? (
                  ...
                  <>
                    <AppIcon name="refresh" className="w-3 h-3 mr-1" />
                    Refresh Insights
                  </>
                )}
              </Button>
